...
각 여행지의 상세 정보를 직관적인 UI로 확인할 수 있는 여행 플랫폼입니다. __AI와 연동된 맞춤형 여행 일정 추천__ 기능과 __일정 생성기능__도 제공합니다.
...
## 📸 시연 화면
| 홈 화면 | 여행지 상세 | AI 여행 추천 |
|--------|--------------|----------------|
| <img width="480" height="270" alt="image" src="https://github.com/user-attachments/assets/11950728-93e6-4d9e-9d8c-dba613a84a2c" />
 | <img width="480" height="270" alt="image" src="https://github.com/user-attachments/assets/7bbc990a-3e9a-457a-8e26-356f55e1c186" />
 |  |
